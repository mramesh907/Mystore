            ...
            <div className="flex items-center gap-2 justify-between mt-3">
              {
                ...
                <button disabled={!validateForm} className={`${validateForm ? "bg-green-800 hover:bg-green-700" : "bg-gray-500"}  text-white rounded py-2 font-semibold my-3 tracking-wide`}>Verify Otp</button>
        </form>
