           ...
           <div className="grid gap-1">
            ...
            <div className="bg-blue-50 p-2 border rounded flex items-center focus-within:border-primary-200">
              ...
              >
                ...
                <button disabled={!validateForm} className={`${validateForm ? "bg-green-800 hover:bg-green-700" : "bg-gray-500"}  text-white rounded py-2 font-semibold my-3 tracking-wide`}>Change Password</button>
        </form>
