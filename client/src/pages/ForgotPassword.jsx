        ...
        <form className="grid gap-4 py-4 mt-6" onSubmit={handleSubmit}>
          ...
          <div className="grid gap-1 ">
            ...
            />
                ...
                <button disabled={!validateForm} className={`${validateForm ? "bg-green-800 hover:bg-green-700" : "bg-gray-500"}  text-white rounded py-2 font-semibold my-3 tracking-wide`}>Send Otp</button>
        </form>
