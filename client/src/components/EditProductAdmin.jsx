...
const EditProductAdmin = ({ fetchProductData, data2, close }) => {
  ...
  return (
    <section className='fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 bottom-0 right-0 z-50 p-4'>
      <div className='bg-white rounded p-4 w-full max-w-2xl mx-auto overflow-y-auto h-full min-h-[90vh]'>
        <section>
