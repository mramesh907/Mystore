...
export async function logoutController(req, res) {
    try {
        ...
        const removeRefreshToken = await UserModel.findByIdAndUpdate({ _id: userid }, { refreshToken: "" })
...
export async function uploadAvatar(req, res) {
    try {
        ...
        const updateUser = await UserModel.updateOne({ _id: userId }, { avatar: upload.url })
